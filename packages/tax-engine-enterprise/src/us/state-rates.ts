...
// Tax Foundation). This is a dated snapshot of the 2026 tax year, NOT a
// statement of current law — state rates change frequently (2026 itself saw
// Nebraska, North Carolina and Pennsylvania reduce rates; Kansas moved to a
// graduated 4%/7% structure in 2024; NE cuts further to 3.99% in 2027 subject
// to revenue). Re-verify against the latest source before any use; the
// `docs` provenance in `external-snapshots.ts` records the source of each
...
export const STATE_TAX_REFERENCE: readonly StateTaxReference[] = [
  ...
  { stateCode: 'DE', stateName: 'Delaware', topRate: 0.087, rateNotes: 'flat 8.7% (plus gross receipts licensing tax)', apportionment: 'equal three-factor (verify)', cite: '30 Del. C. §1902' },
  { stateCode: 'FL', stateName: 'Florida', topRate: 0.055, rateNotes: 'flat 5.5% (first $50,000 exempt)', apportionment: 'single sales (verify)', cite: 'Fla. Stat. §220.11' },
  ...
  { stateCode: 'KS', stateName: 'Kansas', topRate: 0.07, rateNotes: 'graduated 4% up to $50,000, 7% above', apportionment: 'single sales (verify)', cite: 'K.S.A. §79-32-110' },
  ...
  { stateCode: 'NM', stateName: 'New Mexico', topRate: 0.059, rateNotes: 'flat 5.9%', apportionment: 'single sales (verify)', cite: 'NMSA §7-2A-4' },
  ...
  { stateCode: 'ND', stateName: 'North Dakota', topRate: 0.0431, rateNotes: 'graduated 1.41–4.31% (top above $50,000)', apportionment: 'single sales (verify)', cite: 'N.D.C.C. §57-38-30' },
  ...
  { stateCode: 'OK', stateName: 'Oklahoma', topRate: 0.04, rateNotes: 'flat 4%', apportionment: 'single sales (verify)', cite: '68 O.S. §2355' },
